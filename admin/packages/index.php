                            ...
                            <section class="col-12 col-sm-9 col-md-20">
                                <form class="form-container" action="connect.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="InputTitle" aria-describeby=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="InputFees"
                                            placeholder="Enter Package Fees" name="fees">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputFees">Image</label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="flex">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="InputDuration"
                                                placeholder="Enter Package Duration" name="Duration">
