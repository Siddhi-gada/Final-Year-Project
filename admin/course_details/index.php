...
echo '<table>';
echo '<tr>';
echo '<th width="8.5%">Title</th>';
echo '<th width="10.5%">Description</th>';
echo '<th width="8.5%">Fees</th>';
echo '<th width="12.5%">Start Date</th>';
echo '<th width="12.5%">End Date</th>';
echo '<th  width="6.5%" colspan="2">Action</th>';
echo '</tr>';
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<td width="100px">' . $row['Fees'] . '</td>';
    echo '<td width="100px">' . $row['start_date'] . '</td>';
    echo '<td width="100px">' . $row['end_date'] . '</td>';
 echo '<td width="100px">' . '<a href="..\course_update\index.php?id=' . $row['id'] . '"><button class="update">' . 'Update' . '</button></a>' . '</td>';
