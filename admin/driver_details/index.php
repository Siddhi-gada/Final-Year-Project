...
// Execute a SQL query
$result = mysqli_query($conn, 'SELECT * FROM driver_register');
...
echo '<td width="100px">' . '<a href="..\driver_show\driver_index.php?id=' . $row['id'] . '"><button class="update">' . 'Show' . '</button></a>' . '</td>';
    echo '</tr>';
