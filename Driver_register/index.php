...
<body>
    <div class="container">
        <div class="column1">
            <form name="registrationForm" enctype='multipart/form-data' onsubmit="return validateForm()" action="connect.php" method="post">
                <h2>Driver Register</h2>
                <div class="form-control">
                    <label for='Inputfirstname'>First name</label>
                    <input type="text" name="firstname" class="form-control" id="firstname"
                        placeholder="Enter first name" onchange="validateCharactersOnly(this)">
                </div>
                <div class="form-control">
                    <label for='Inputmiddlename'>Middle name</label>
                    <input type="text" onchange="validateCharactersOnly(this)" name="middlename" class="form-control"
                        id="middlename" placeholder="Enter middle name">

                </div>
                <div class="form-control">
                    <label for='lastname'>Last name</label>
                    <input type="text" onchange="validateCharactersOnly(this)" name="lastname" class="form-control"
                ...
                <div class="form-control">
                    ...
                    <input type="phone" name="phone" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" class="form-control" id="phone"
                        placeholder="Enter Phone Number">

                </div>
                <div class="form-control">
                    <label for='email'>Email</label>
                    <input type="email" onchange="validateName(this)" name="emailid" id="emailid"
                        placeholder="Enter email">
                </div>
                <div class="form-radio">
                    <label for="workExperience">Do you have any work experience?</label><br>
                    <input type="radio" id="workExperience" name="workExperience" value="yes"
                        onchange="toggleInput()">Yes
                    <br>
                    <input type="radio" id="workExperience" name="workExperience" value="no">No
                    <br>
                ...
                <div class="form-radio">
                    ...
                    <input type="radio" id="certification" name="certification" value="yes"
                        onchange="CertificateInput()">Yes
                    <br>
                    <input type="radio" id="certification" name="certification" value="no">No
                    <br>
                ...
                <button name="submit" value="Upload Image" class="btn btn-primary btn-block">Register</button>
